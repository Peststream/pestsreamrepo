...
public class TermiteEmployeePage extends peststreamPage {
	...
	@FindBy(xpath = "(//span[contains(.,'--Select--')])[12]")
	...
	@FindBy(xpath = "/html//select[@id='DepartmentSysName']")
	...
	public void clickon_DDDept_SupervisorTimeSheetEmpTermite() throws Exception {
		jsonData = JsonHelper.readJsonElementInteger("waitTime.json", "SleepTime");
		WebDriverWait wait = new WebDriverWait(getDriver(), jsonData.get("Time1"));
		wait.until(ExpectedConditions.elementToBeClickable(DDDeptSupervisorTimeSheetEmpTermite));
	...
	public void clickon_DDTimeSlot_SupervisorTimeSheetEmpTermite() throws Exception {
		jsonData = JsonHelper.readJsonElementInteger("waitTime.json", "SleepTime");
		WebDriverWait wait = new WebDriverWait(getDriver(), jsonData.get("Time1"));
		wait.until(ExpectedConditions.elementToBeClickable(DDTimeSlotSupervisorTimeSheetEmpTermite));
